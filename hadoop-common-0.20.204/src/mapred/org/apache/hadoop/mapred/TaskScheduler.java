...
abstract class TaskScheduler implements Configurable {
   ...
   * HACK DONE HERE
   */
  protected List<String> mapHostsToIgnore;
  
  protected List<String> reduceHostsToIgnore;
  
  public void setMapHostsToIgnore(List<String> list){
	  this.mapHostsToIgnore=list;
  }
  
  public void setReduceHostsToIgnore(List<String> list){
	  this.reduceHostsToIgnore=list;
  }
