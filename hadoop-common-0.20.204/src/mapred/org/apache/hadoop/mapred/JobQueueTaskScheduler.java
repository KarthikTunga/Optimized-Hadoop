...
class JobQueueTaskScheduler extends TaskScheduler {
  ...
  public synchronized List<Task> assignTasks(TaskTracker taskTracker)
    ...
    /*
     * HACK for ignoring a node for executing maps.
     */
    boolean canScheduleMaps=true;
    for(String hostToIgnore:this.mapHostsToIgnore){
    	if(taskTrackerStatus.getHost().equals(hostToIgnore)){
    		canScheduleMaps=false;
    		break;
    	}
    }
     ...
     * HACK
     */
    String currentHost = taskTrackerStatus.getHost();
    for(String hostToIgnore:this.reduceHostsToIgnore){
    	if(currentHost.equals(hostToIgnore))
